...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/381343743098433).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="28f4e4fbc89942a698d674733d865aaf", artifact_path="data", dst_path=input_temp_dir)
...
supported_cols = ["Annee_construction", "N_departement_BAN", "Conso_5usages_m2e_finale", "Code_INSEE_BAN", "Cout_chauffage_energie_n2", "Type_generateur_n1_installation_n2", "Qualite_isolation_plancher_bas", "Emission_GES_chauffage_energie_n2", "Qualite_isolation_plancher_haut_comble_amenage", "Type_batiment", "Conso_5usages_finale_energie_n2", "Qualite_isolation_plancher_haut_toit_terrase", "EmissionGES_eclairage", "Conso_chauffage_depensier_installation_chauffage_n1", "Hauteur_sous_plafond", "Cage_escalier", "Codepostal_brut", "Conso_5usagese_finale", "Surface_totale_capteurs_photovoltaique", "Classe_altitude", "Description_generateur_chauffage_n2_installation_n2", "Codepostal_BAN", "Qualite_isolation_enveloppe", "Qualite_isolation_plancher_haut_comble_perdu", "Configuration_installation_chauffage_n2", "Type_energie_n3", "Qualite_isolation_murs", "Type_emetteur_installation_chauffage_n2", "Type_generateur_froid", "Qualite_isolation_menuiseries", "Nom_commune_Brut", "Surface_habitable_logement"]
...
num_imputers = []
num_imputers.append(("impute_mean", SimpleImputer(), ["Annee_construction", "Codepostal_BAN", "Codepostal_brut", "Conso_5usages_finale_energie_n2", "Conso_5usages_m2e_finale", "Conso_5usagese_finale", "Conso_chauffage_depensier_installation_chauffage_n1", "Cout_chauffage_energie_n2", "EmissionGES_eclairage", "Emission_GES_chauffage_energie_n2", "Hauteur_sous_plafond", "Surface_habitable_logement", "Surface_totale_capteurs_photovoltaique"]))
...
numerical_transformers = [("numerical", numerical_pipeline, ["Conso_chauffage_depensier_installation_chauffage_n1", "Emission_GES_chauffage_energie_n2", "Codepostal_BAN", "Hauteur_sous_plafond", "Annee_construction", "Codepostal_brut", "Conso_5usagese_finale", "Conso_5usages_m2e_finale", "Cout_chauffage_energie_n2", "Conso_5usages_finale_energie_n2", "Surface_totale_capteurs_photovoltaique", "EmissionGES_eclairage", "Surface_habitable_logement"])]
...
categorical_one_hot_transformers = [("onehot", one_hot_pipeline, ["Cage_escalier", "Classe_altitude", "Configuration_installation_chauffage_n2", "Description_generateur_chauffage_n2_installation_n2", "N_departement_BAN", "Qualite_isolation_enveloppe", "Qualite_isolation_menuiseries", "Qualite_isolation_murs", "Qualite_isolation_plancher_bas", "Qualite_isolation_plancher_haut_comble_amenage", "Qualite_isolation_plancher_haut_comble_perdu", "Qualite_isolation_plancher_haut_toit_terrase", "Type_batiment", "Type_emetteur_installation_chauffage_n2", "Type_energie_n3", "Type_generateur_froid", "Type_generateur_n1_installation_n2"])]
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/381343743098433)
...
def objective(params):
  with mlflow.start_run(experiment_id="381343743098433") as mlflow_run:
...
space = {
  "colsample_bytree": 0.7714957116328811,
  "lambda_l1": 1.6755844545899221,
  "lambda_l2": 0.16116040187110844,
  "learning_rate": 0.47039743718110716,
  "max_bin": 299,
  "max_depth": 6,
  "min_child_samples": 23,
  "n_estimators": 16,
  "num_leaves": 8,
  "path_smooth": 61.697648769737704,
  "subsample": 0.58293209988621,
  "random_state": 16997240,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=16997240).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=16997240).fillna(mode)
...
displayHTML(f"<a href=#mlflow/experiments/381343743098433/runs/{ mlflow_run.info.run_id }/artifactPath/model> Link to model run page </a>")
